...
class profile(models.Model):
    ...
    pfp = models.ImageField(default='profile.jpg', upload_to='profile_pics/', null=True, blank=True)
    cover = models.ImageField(default='cover.jpg', upload_to='cover_pics/', null=True, blank=True)
